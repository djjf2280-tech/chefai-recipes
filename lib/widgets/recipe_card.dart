              ...
              child: Stack(children: [
                ...
                Positioned(top: 8, right: 8, child: GestureDetector(
                  ...
                  child: Container(
                    width: 32, height: 32,
                    decoration: BoxDecoration(
                      color: isFav ? Colors.red.shade500 : Colors.black38,
                ...
                Positioned(top: 8, left: 8, child: Container(
                  ...
                  child: Text(recipe.category, style: const TextStyle(color: Colors.white, fontSize: 9, fontWeight: FontWeight.w800)),
                )),
                // Кухня в нижнем левом
                if (recipe.cuisine.isNotEmpty)
                  Positioned(bottom: 8, left: 8, child: Container(
                    ...
                    child: Text(recipe.cuisine, style: const TextStyle(color: Colors.white70, fontSize: 8, fontWeight: FontWeight.w600)),
                  )),
              ]),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Text('${recipe.totalTime}м', style: TextStyle(fontSize: 10, color: Colors.grey.shade500, fontWeight: FontWeight.w600)),
                  const Spacer(),
                  Container(width: 7, height: 7, decoration: BoxDecoration(color: recipe.difficultyColor, shape: BoxShape.circle)),
                  const SizedBox(width: 3),
                  Text(recipe.difficulty, style: TextStyle(fontSize: 10, color: Colors.grey.shade500, fontWeight: FontWeight.w600)),
                ]),
                const SizedBox(height: 4),
                Text('🔥 ${recipe.calories} ккал', style: TextStyle(fontSize: 10, color: AppTheme.primary.withOpacity(0.85), fontWeight: FontWeight.w700)),
              ]),
            ),
          ),
        ]),
